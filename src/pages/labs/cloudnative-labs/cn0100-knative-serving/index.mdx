...
In this lab, you learn how to install OpenShift Serverless Operator, deploying a few serverless application, and work with Knative revision, traffic distribtuion and scaling capabilities. You will see that Knative Serving is easy to get started with and scales to support advanced scenarios.
...
* learn how to use Knative Serving features like revision, tranfic distribution and scaling
...
2. Navigate to **/home/ibmdemo/app-mod-labs/cn0100st** directory.
...
4. Review the content of **colors-service-blue** and **colors-service-green** with commands:
...
7. Deploy the severless application **blue-green-canary** with command:
...
11. Close the service window, wait for a few minutes, then go back to the OCP web console and check the pod under the **cn0100st** project, you see there is no any pods. This is because it is a serverless service, which means that once no more traffic is directed into the service, it comes down automatically. This is called **scale-to-zero**.
