...
description: 
---
The goal of this session is to provide a hands-on experience on how to work with OpenShift Knative.
...
2. Scroll down to **kn - OpenShift Serverless Command Line Interface (CLI)** section and click **Download for Linux for x86_64** link.

  ![](images/knative-cli-link.png) 

3. Click **Save File** option and click **OK**.

  ![](images/knative-cli-save-file.png) 

  The Knative CLI package is saved to **/home/ibmdemo/Downloads** directory.

4. Run the commands below to unpack the Knative CLI and set it up.
...
5. To verify the Knative CLI installation, issue the following command:
...
#### 6.5 Create a Sample Serverless Application

Once you have the Knative CLI installed, you can use it to create Knative applications.

In this task, you are going to create a simple **Greetings** application.
...
5. Build the application with command:
...
6. Test the application locally.
  ...
  a. Launch the application in command line.
  ```
  kn func run
  ```
...
#### 6.6 Deploy the Sample Serverless Application

Next, you are going to deploy this application to the OpenShift cluster. 
