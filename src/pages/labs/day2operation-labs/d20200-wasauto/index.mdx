...
description: Strengthen Operational Security with IBM WebSphere Automation
---
...
*	access WebSphere Automation UI
* get configuration parameters
* configure Liberty server
* configure WAS server
* update Liberty server to fix vulnerability
* update WAS server to fix vulnerability
...
1. On the login page, click **htpasswd** field. Then log in with **ibmadmin**/**engageibm** as the username and password.
...
1. On the Welcome page, open the **Menu**, click **Operate**, and then click **Application runtimes**.
...
1. Open the **Notification configuration** tab.
