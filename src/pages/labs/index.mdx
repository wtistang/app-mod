...
1. [DV0100 - Using Tekton Pipelines for CI/CD of Microservices to Red Hat OpenShift Container Platform](/labs/devops-labs/dv0200-tekton/)
2. [DV0200 - Move an existing application to OCP using Transformation Advisor and Cloud Pak for Applications Pipeline](/labs/devops-labs/dv0300-devops/)
