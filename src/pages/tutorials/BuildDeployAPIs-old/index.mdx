...
In this tutorial, you use the IBM App Mod Workshop 2020.4.1 to deploy an App Integration flow on containers and expose it as a secure rate-limited API on RedHat OpenShift 4.6.
...
6.Click the IBM App Mod Workshop Platform Navigation. Locate MQ and click the MQ instance name: **mq-demo**.
...
2.In **Welcome IBM App Mod Workshop** – **Capabilities**, click **API Connect** link name.
...
2.To push our new API to **Asset Repository** we must return to the API Manager. In **Welcome IBM App Mod Workshop – Capabilities**, click **API Connect** link name.
...
### Now that you’ve made your back-end integrations ready for external distribution, your developer community is able to access the APIs via a developer portal. The developer portal is included in the platform and provides a full-featured experience to onboard and nurture your API consumers. To try out more labs, go to App Mod Workshop Demos. For more information about App Mod Workshop, go to https://www.ibm.com/cloud/cloud-pak-for-integration
