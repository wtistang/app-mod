...
In this tutorial, you use the App Mod Workshop 2020.4.1 to create an App Integration flow (IBM App Connect Enterprise) that sends messages to a queue (IBM MQ) on OpenShift 4.6.
...
The App Mod Workshop - Operations Dashboard Add-on provides cross-component monitoring and tracing capabilities that enable IT personnel to quickly analyze performance bottlenecks and latency problems across integration components to help ensure high levels of service.
...
1.Open a browser and click **IBM App Mod Workshop&& toolbar. Click **Capabilities** and select the **App Connect Dashboard** link.
...
5.A message was sent from App Connect (Integration Server) to IBM Event Streams. Go to **IBM App Mod Workshop**.  Select **Runtimes** and click **Event Streams** application.
...
1.Go to the **IBM App Mod Workshop**. Click the **tracing** application  to open the Operations Dashboard instance.
