...
Streams for enterprises. On OpenShift® 4.4 and IBM App Mod Workshop 2020.2.1, IBM Event Streams offers enterprise-grade security, scalability, and reliability running on Red Hat® OpenShift® Container Platform as certified contain.
...
<AnchorLinks>
  ...
  <AnchorLink>Installing an IBM Event Streams v.10 instance in IBM App Mod Workshop using Red Hat Operators</AnchorLink>
...
As this is a new deployment of the App Mod Workshop, you must execute some steps to prepare the environment. Initial setup steps are only needed for a fresh installation of the platform. They do not need to be repeated.
All work for this lab is done on the Developer Machine. Open the developer Machine VM by clicking the tile.

## Takeaways

-   Preparing IBM App Mod Workshop 2020.2.1 running on Red Hat OpenShift 4.4
...
-   Installing  an IBM Event Streams v.10 instance in IBM App Mod Workshop using Red Hat Operators
