...
Because this is a new deployment of the App Mod Workshop that uses Red Hat OpenShift, you need to run some steps to prepare the environment. Initial setup steps are only needed for a fresh installation of the Cloud Pak. They do not need to be repeated.
...
4.	Click link to access App Mod Workshop .
```
...
10.In the **Welcome page of the IBM App Mod Workshop**, click **Runtimes** and locate the **Queue Manager** in Instance Type and click **mq-demo**.
...
1.Open a browser and go to IBM App Mod Workshop. Select **Runtimes** and click **mq-demo**.
...
8.Back to IBM App Mod Workshop. Select **Runtimes** and click **es-demo**. In the **Welcome to IBM Event Streams**, click **Topics** on the left.
...
29.	Open a browser and click IBM App Mod Workshop. Select **Runtimes** and click mq-demo.
...
**App Mod Workshop Operations Dashboard Add-on** is designed to help organizations that need to meet and ensure maximum service availability and react quickly to any variations in their systems.
...
To try out more labs, go to App Mod Workshop Demos. For more information about the App Mod Workshop, go to https://www.ibm.com/cloud/cloud-pak-for-integration.
